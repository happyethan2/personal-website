...
These retreats have been pivotal in shaping my mindset around meditaiton and have catalysed my interest in philosophical inquiry; both internal and external.
...
For example, you might get into a car accident and from that moment onward your brain can chose to interpret that in many different ways. How it does so determines your emotional response, and in saying so, the quality of your life at that particular time. Simply being aware of how your mind interprets reality is enough to exercise your agency about how you'll manage that reality. To summarise, we can think of Bitcoin as *minimising trust*, whereas meditation is more *transcending truth*. There's an ancient (quite famous) Buddhist scripture known as the Kalama Sutta (as it's known in the west) which stresses that we shouldn't rely on tradition, scripture, logic, consensus, or authority, but rather question our reality, exercising independent verification through lived experience and the freedom to doubt. This scripture is a reminder that humans have been contemplating philosophy as it concerns truth for at least 2500 years.
...
To explain what enlightenment is would be paradoxical as it's a direct experience beyond concepts, words or dualities. It would be like attempting to describe the colour blue to someone who's never had the faculty of vision—you inevitably fall short, because language is built out of distinctions, and the state being described is said to transcend those distinctions. Bitcoin, on the other hand, is a concrete socioeconomic structure, yet both reshape one's frame of reference so thoroughly that before-and-after worlds feel incommensurable. Enlightenment dissolves the lens of ego or "self", whereas Bitcoin dissolves the lens of fiat money, inflation, and debt-based finance. I can sit here and explain Bitcoin's mechanics (just like meditative techniques), but the *experience* of lowering your time preference and developing financial sovereignty and detachment from fiat volatility resists complete explanation. I often find people describe Bitcoin as cultish, precisely because the benefits are easier experienced (wisdom), not just intellectualised about (reason).

<br/>
### Timestamping Enlightenment

Time for a small technical detour to tie together enlightenment with the blockchain. If you pay somebody on the Bitcoin network you have the option of including some additional miscellaneous data with your transaction (up to the size of 80 bytes at the time of writing). When your transaction gets included in a block, that data is there forever—immutable. The beauty of this is revealed when considering a hash function and realising we can cram any amount of data under the 80 byte limit by hashing it. If the Pharisees had Bitcoin at the time the Bible was being authored they could have done this, and all it would take to verify that the copy we have today has been maintained in its purity would be to compare the hash of the contemporary version with the first edition. This wouldn’t confirm the truth of the Bible’s content, but it would prove that the exact version we have today existed at the moment it was committed to the blockchain.
